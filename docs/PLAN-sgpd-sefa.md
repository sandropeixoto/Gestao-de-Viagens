...
- **OUTPUT:** Migrations SQL com tabelas `profiles`, `roles`, `travel_requests`, `expenses`, `tables_decrees` e `transport_types`. Políticas RLS implementadas. Trigger de verificação de domínio de email (`@sefa.pa.gov.br`).
